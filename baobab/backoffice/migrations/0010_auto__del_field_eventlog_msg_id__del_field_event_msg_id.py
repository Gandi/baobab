...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'backoffice_eventlog', 'msg_id')

        # Deleting field 'Event.msg_id'
        db.delete_column(u'backoffice_event', 'msg_id')


    def backwards(self, orm):
        # Adding field 'EventLog.msg_id'
        db.add_column(u'backoffice_eventlog', 'msg_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True),
                      keep_default=False)

        # Adding field 'Event.msg_id'
        db.add_column(u'backoffice_event', 'msg_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True),
                      keep_default=False)
