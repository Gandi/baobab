...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventLog.msg_id'
        db.add_column('backoffice_eventlog', 'msg_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(
                          default=None, null=True),
                      keep_default=False)

        # Adding field 'EventLog.msg'
        db.add_column('backoffice_eventlog', 'msg',
                      self.gf('django.db.models.fields.CharField')(
                          max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Event.msg_id'
        db.add_column('backoffice_event', 'msg_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(
                          default=None, null=True),
                      keep_default=False)

        # Adding field 'Event.msg'
        db.add_column('backoffice_event', 'msg',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EventLog.msg_id'
        db.delete_column('backoffice_eventlog', 'msg_id')

        # Deleting field 'EventLog.msg'
        db.delete_column('backoffice_eventlog', 'msg')

        # Deleting field 'Event.msg_id'
        db.delete_column('backoffice_event', 'msg_id')

        # Deleting field 'Event.msg'
        db.delete_column('backoffice_event', 'msg')
    ...
    models = {
        ...
        'backoffice.event': {
            ...
            'msg_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
        ...
        'backoffice.eventlog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'msg': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'msg_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
